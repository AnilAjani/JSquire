...
public class StringKihon extends StringKihonBase {
    ...
    @Override
    protected String Remove_All_Leading_Whitespace(String data) { return data.trim(); }
    ...
    @Override
    protected String[] Split_A_String_Into_An_Array(String input, char divider) { return input.split("_"); }

    @Override
    protected String Join_An_Array_Into_A_String(String[] input, String divider) { return String.join("_"); }
